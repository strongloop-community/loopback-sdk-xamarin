...
namespace UnitTests
{
	...
	public class a_TestCRUDAllButUser
	{
		...
		public void crud_c14_CustomerFindOne(){
            try
            {
                Customer result = Customers.FindOne(customerBadFilter).Result;
                Assert.Fail();
            }
		...
		public void crud_r14_ReviewsFindOne(){
            try
            {
                Review result = Reviews.FindOne(reviewBadFilter).Result;
                Assert.Fail();
            }
            catch (AggregateException e)
            {
		...
		public void crud_o14_OrdersFindOne(){
            try
            {
                Order result = Orders.FindOne(orderBadFilter).Result;
                Assert.Fail();
            }
            catch (AggregateException e)
            {
			...
			Order ord = Orders.FindOne ().Result;
